...
export function AdminSettings() {
  return (
    <div className="space-y-6">
      ...
      <p className="text-slate-400 mb-8">Manage application configurations and preferences.</p>
          ...
          <div className="space-y-4 text-slate-300">
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <div>
                ...
                <p className="text-sm text-slate-400">Temporarily disable access for staff</p>
              </div>
            ...
            <div className="flex items-center justify-between border-b border-white/5 pb-4">
              <div>
                ...
                <p className="text-sm text-slate-400">Send summary reports to admins</p>
              </div>
