    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          role: 'ai',
          content:
            'Sorry, I encountered an error while analyzing the attendance data.',
        },
      ]);
    } finally {
      setLoading(false);
    ...
    <div className="space-y-6 h-[80vh] flex flex-col">
      ...
      >
        ...
        <p className="text-slate-400 text-lg">
          Ask natural language questions about your team's attendance data.
        </p>
      </motion.div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6 relative z-10 custom-scrollbar">
          {messages.length === 0 ? (
            ...
            >
              ...
              <p>
                Ask me questions like "Who worked overtime last week?" or "Which
                team has the highest attendance rate?"
              </p>
            </motion.div>
          ) : (
